...
class LivingAssetGeneration implements AssetAction {
	private final AssetType assetType;
	private final AssetType providedAssetType;
	private final int quantityProvided;
	
	public LivingAssetGeneration(AssetType assetType, AssetType providedAssetType, int quantityProvided) {
		super();
	...
	public void perform(Assets assets, Tools tools, PublicAssets publicAssets, PublicLocations publicLocations) {
		assets.addAsset(new LivingAsset(providedAssetType));
	}
